...
export default function AboutPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in mb-10">
      <div className="space-y-1.5"><h1 className="text-display-sm text-on-dark">Acerca de TrackingCF</h1><p className="text-body-md text-muted max-w-2xl">Seguimiento de rachas, análisis de progreso y estadísticas para Codeforces.</p></div>

      <div className="grid gap-4 md:grid-cols-2">
        <div className="space-y-4">
          <Card className="rounded-xl p-4">
            <CardTitle className="text-body-md text-on-dark mb-3">Creador</CardTitle>
            ...
            : creator ? <div className="flex items-start gap-3">
                <div className="relative shrink-0"><div className="h-12 w-12 overflow-hidden rounded-lg border-2 border-surface-elevated-dark"><Image src={creator.avatar_url} alt="zlarosav" width={48} height={48} className="h-full w-full object-cover" unoptimized /></div><div className="absolute -bottom-1.5 -right-1.5"><StreakBadge streak={creator.current_streak} isActive={creator.streak_active} /></div></div>
          ...
          <Card className="rounded-xl p-4">
            <CardTitle className="text-body-md text-on-dark flex items-center gap-1.5 mb-3"><Code className="h-4 w-4 text-primary" />Open Source</CardTitle>
            <div className="space-y-2">
              ...
              {[{ label: "Frontend", url: "https://github.com/zlarosav/TrackingCF-frontend" }, { label: "Backend", url: "https://github.com/zlarosav/TrackingCF-backend" }].map(r => (
                <a key={r.label} href={r.url} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-2 rounded-md bg-surface-elevated-dark hover:bg-surface-elevated-dark/80 transition-colors">
        ...
        <div className="space-y-4">
          <Card className="rounded-xl p-4">
            <CardTitle className="text-body-md text-on-dark mb-3">¿Qué es?</CardTitle>
          ...
          <Card className="rounded-xl p-4">
            <CardTitle className="text-body-md text-on-dark mb-3">Tecnologías</CardTitle>
